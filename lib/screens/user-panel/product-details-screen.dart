// ignore_for_file: file_names, must_be_immutable, prefer_interpolation_to_compose_strings, unused_local_variable, avoid_print, deprecated_member_use, sized_box_for_whitespace
...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
  ...
  // }) async {
  //   final number = "94755192242";
  //   final message =
  //       "Hello Computer Part Store \n i want to know about this product \n ${productModel.productName} \n ${productModel.productId}";
